...
{
    private Dictionary<SoldierType, SoldierCamp> mSoldierCamp = new Dictionary<SoldierType, SoldierCamp>();
    ...
    private void InitCamp(SoldierType soldierType) {
        ...
        mSoldierCamp.Add(soldierType, camp);
    ...
    {
        //更新所有兵营内部游戏逻辑
        foreach (SoldierCamp camp in mSoldierCamp.Values)
        {
            camp.Update();
        }
